...
const galleryImages = [
  ...
  { src: '/Soft glam2.jpeg', alt: 'Soft Glam Elegance', span: 'col-span-1 row-span-2' },
  ...
  { src: '/FullGlam2.jpeg', alt: 'Full Glam Transformation', span: 'col-span-1 row-span-2' },
  ...
  { src: '/basicsoftglam.jpeg', alt: 'Natural Soft Glam', span: 'col-span-1 row-span-1' },
  ...
  { src: '/softglam cover.jpg', alt: 'Soft Glam Cover Look', span: 'col-span-1 row-span-1' },
